...
public class UnZip {
    ...
    private static final String INPUT_ZIP_FILE = "C:\\Program Files\\Java\\jdk1.8.0_162\\src.zip";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The number of java files in the sources of the JDK 1.8.0_162: " + listFiles.size() + " files.");
        System.out.println("The Number of java files that contain annotation @FunctionalInterface:");
